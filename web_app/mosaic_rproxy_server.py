...
# Reverse proxy server to acces the Mosaic integrated Web Server
...
if __name__ == "__main__":
    try:
        ...
        socketio.run(app, host = "::", port = rtkbaseconfig.get("main", "gnss_rcv_web_proxy_port", fallback=9090)) # IPv6 "::" is mapped to IPv4
